...
List_TMM_PAA <- unique(sub_accouch12$Type_Accouchement)
List_TEVP_TEV2500 <- unique(sub_accouch13$Naissance)
...
data_health <- merge(sub_accouch11a, sub_accouch12a, sub_accouch13a, all=T)
...
label="tab6",digits=1)
print(tab6, include.rownames = FALSE)
